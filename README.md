...
| **[Simulation Système Solaire](https://github.com/nedelec/solar-system-simulation)** | **Physique Numérique.** Simulation N-Corps utilisant l'intégrateur **Runge-Kutta 4** pour une précision orbitale maximale. | `Python` `NumPy` `Matplotlib` |
---
